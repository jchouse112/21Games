...
const SPORTS: Array<{
  ...
  { name: "Hoops 21", metric: "5-8 players · 3-pointers", status: "Live", featured: true, icon: "basketball", href: "/play/nba" },
...
const FAQ = [
  ...
  { q: "Can I change my bet after placing it?", a: "You can Hit to add a team or player to an open bet — costs 25% of your original stake. Baseball maxes out at 6 picks; hockey, hoops, and football max out at 8; soccer is planned for 9. The pick has to still be early: before the 4th inning in baseball, before the 2nd period in hockey, before the 2nd quarter in hoops/football, or before the end of the 1st half in soccer. No cash-out, no lock-in." },
  ...
  { q: "What sports can I play?", a: "Baseball 21, Ice 21, Pitch 11, and Hoops 21 are live. Gridiron is rolling out through the season." },
